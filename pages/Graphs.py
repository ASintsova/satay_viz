...
def app():
    ...
    cols_needed = ['Chromosome', 'Start', 'foldChange', 'location', 'gene', 'Distance', 'gene_start', 'gene_end', 'Strand']
    ...
    fig = px.scatter(df, x='Start', y='foldChange', size='logpval', hover_data={'location': False,
                     ...
                     template='simple_white', labels={'Start': 'Position, bp', 'foldChange': 'log2 fold change',
    ...
    st.write(gdf.sort_values('Start')[['location', 'foldChange', 'padj', 'gene', 'Distance', 'gene_start', 'gene_end', 'Strand']])